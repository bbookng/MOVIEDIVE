  ...
  <div>
    ...
    <div>
      <div v-if="!flag">
        <h3>{{ nickname }}</h3>
        <p>{{ message }}</p>
          <button v-if="!changeProfileImgButton" @click="changeProfileImg" type="button" class="btn btn-light">프로필 사진 변경</button>
          <button @click="editButton" type="button" class="btn btn-light">프로필 수정</button>
