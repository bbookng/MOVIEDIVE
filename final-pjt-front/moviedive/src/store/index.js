...
export default new Vuex.Store({
  ...
  state: {
    ...
    newmovielist: [],
    authError: null,
    API_URL: 'https://moviedive.co.kr/api',
    collection: [],
    mypage: 1,
  },
  getters: {
  ...
  actions: {
    ...
    setNickname(context, nickname) {
      ...
      axios({
        method: 'put',
        url: 'https://moviedive.co.kr/api/accounts/profile/set_nickname/',
    ...
    fetchMovies({ commit, getters }, keyword) {
      ...
      */
      ...
      axios({
        url: 'https://moviedive.co.kr/api/movies/' +query,
        method: 'get',
        headers: getters.authHeader,
      })
        .then(res => {
    ...
    fetchMain({ commit, getters }) {
      axios({
        url: `${API_URL}/collections/main`,
        method: 'get',
        headers: getters.authHeader,
      })
        .then(res => {
